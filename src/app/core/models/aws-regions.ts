/**
 * Common AWS commercial regions, for the region input's suggestion list. Not exhaustive and not a
 * hard constraint — the field stays free-text so GovCloud / China / brand-new regions still work.
 */
